...
#define ERROR_DESCONEXION_CONSOLA -22
#define ERROR_DESCONEXION_KERNEL -23
#define ERROR_DESCONEXION_MEMORIA -24
#define ERROR_DESCONEXION_CPU -25
#define ERROR_AL_RECIBIR_MENSAJE -26
#define ERROR_MENSAJE_DESCONOCIDO -27
