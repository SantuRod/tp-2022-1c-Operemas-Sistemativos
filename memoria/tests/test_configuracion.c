...
#include "../src/configuracion/memoria_configuracion.h"
#include <cspecs/cspec.h>
#include <stdlib.h>

context(test_archivo_configuracion) {
	describe("ram_configuracion.h - son_validos_los_parametros") {
	...
	describe("ram_configuracion.h - iniciar_configuracion") {
